...
\begin{figure*}[!h]
\centering
\subfloat[]{\includegraphics[width=0.24\textwidth]{Final_Error_Visual.png}
\label{fig_first_case}}
\hfil
\subfloat[]{\includegraphics[width=0.44\textwidth]{brain_final.png}
\label{fig_second_case}}
\hfill
\subfloat[]{\includegraphics[width=0.3\textwidth]{NW.png}
...
\begin{figure}[!h]
\centering
\includegraphics[width=0.4\textwidth]{NW.png}%
...
\begin{figure}[!h]
\centering
\includegraphics[width=0.48\textwidth]{vissem.png}%
